...
?>
<?php	
	function displayUpcomingBookings($db)
	{
			//create a query
	...
	$query= "SELECT Bookings.bookingPrice, bookings.id, bookings.noOfTravs, trips.tripID, trips.price, trips.title, trips.startLocation, trips.finishLocation,
	trips.country, trips.departingDate, trips.finishingDate
			...
			WHERE bookings_users.user_id= :userID && trips.departingDate >= CURRENT_DATE()";
	...
	$result->execute($params);
		...
		while($row = $result->fetch(PDO::FETCH_ASSOC)) 
		{
			...
			print ("<td><p> $row[noOfTravs] 
			<form action=\"editTravellers.php\" method=\"post\">
				<input type=\"hidden\" name=\"bookingID\" value=\"$row[id]\" />
				<input type=\"hidden\" name=\"tripID\" value=\"$row[tripID]\" />
				<input type=\"hidden\" name=\"price\" value=\"$row[price]\" />
				<input type=\"hidden\" name=\"noOfTravs\" value=\"$row[noOfTravs]\" />
			...
			print ("<td>
				...
				<form action=\"deleteBookingFromDB.php\" method=\"post\">
				<input type=\"hidden\" name=\"bookingID\" value=\"$row[id]\" />
				<input type=\"hidden\" name=\"tripID\" value=\"$row[tripID]\" />
				<input type=\"hidden\" name=\"noOfTravs\" value=\"$row[noOfTravs]\" />
...
<!-- ‘Body’ section	-->
	<?php displayUpcomingBookings($db); ?>			
</div>
