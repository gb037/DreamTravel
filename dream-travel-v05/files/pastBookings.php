...
<?php
	...
	function displayPastBookings($db)
	{
			//create a query
	...
	$query= "SELECT Bookings.bookingPrice, bookings.id, bookings.noOfTravs, trips.title, trips.startLocation, trips.finishLocation,
